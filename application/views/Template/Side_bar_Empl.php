        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-circle-o"></i> Employee Management </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-circle-o"></i> Holiday Requests </a>
                    </li>
                    <li>
                    ...
                    <li class="treeview " >
                        <a href="#"><i class="fa fa-circle-o"></i> Examples <i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview-menu ">
                            <li ><a href="blank.html"><i class="fa fa-circle-o"></i> Blank page</a></li>
                            <li><a href="invoice.html"><i class="fa fa-circle-o"></i> Invoice</a></li>
                            <li><a href="profil.html"><i class="fa fa-circle-o"></i> Profil</a></li>
                    ...
                    <li><a href="calendar.html"><i class="fa fa-circle-o"></i> calendar </a></li>
                </ul>
            </li>
        </ul>
    </section>
